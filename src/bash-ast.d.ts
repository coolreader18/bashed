 ...
 */
export interface Script extends TokenBase {
	type: "Script";
	commands: Array<
		| LogicalExpression
		| Pipeline
 ...
 * the subsequent.
 */
export interface Pipeline extends TokenBase {
	type: "Pipeline";
	commands: Array<
 ...
 * the left one fails.
 */
export interface LogicalExpression extends TokenBase {
 ...
 */
export interface Command extends TokenBase {
	type: "Command";
	name?: Word;
 ...
 */
export interface Function extends TokenBase {
	type: "Function";
	name: Name;
 ...
 */
export interface Name extends TokenBase {
	type: "Name";
	text: string;
}
 ...
 */
export interface CompoundList extends TokenBase {
	type: "CompoundList";
	commands: Array<
		| LogicalExpression
		| Pipeline
 ...
 */
export interface Subshell extends TokenBase {
	type: "Subshell";
	list: CompoundList;
}
 ...
 */
export interface For extends TokenBase {
	type: "For";
	name: Name;
	wordlist?: Array<Word>;
	do: CompoundList;
 ...
 * `clause` Word.
 */
export interface Case extends TokenBase {
	type: "Case";
	clause: Word;
 ...
 * it is matched.
 */
export interface CaseItem extends TokenBase {
	type: "CaseItem";
	pattern: Array<Word>;
 ...
 * `else` one.
 */
export interface If extends TokenBase {
	type: "If";
	clause: CompoundList;
	then: CompoundList;
	else?: CompoundList;
 ...
 */
export interface While extends TokenBase {
	type: "While";
	clause: CompoundList;
	do: CompoundList;
}
 ...
 */
export interface Until extends TokenBase {
	type: "Until";
	clause: CompoundList;
	do: CompoundList;
}
 ...
 */
export interface Redirect extends TokenBase {
	type: "Redirect";
	op: string;
	file: Word;
	numberIo?: number;
 ...
 * on the token.
 */
export interface AssignmentWord extends TokenBase {
	type: "AssignmentWord";
	text: String;
	expansion: Array<ArithmeticExpansion | CommandExpansion | ParameterExpansion>;
}
